...
/**
 * An unchecked implementation of {@link Reflect}, using another {@link Reflect} as a backing and catching any {@link
 * Throwable}s, throwing a runtime exception instead.
 *
...
public final class ReflectUnchecked<T> implements Reflect<T> {
     ...
     *                          on the delegate
     * @see Constructor#newInstance(Object...)
     * @deprecated use parameterised invocation of {@link #instantiate(Object...)} instead
     */
    @Deprecated(forRemoval = true, since = "0.1.3")
     ...
     *                          on the delegate
     * @see Constructor#newInstance(Object...)
     * @deprecated use parameterised invocation of {@link #instantiate(List)} instead
     */
    @Deprecated(forRemoval = true, since = "0.1.3")
    @SuppressWarnings("removal")
    @Override
     ...
     *                          List)} on the delegate
     * @see Constructor#newInstance(Object...)
     * @deprecated use parameterised invocation of {@link #instantiate(List, List)} instead
     */
    @Deprecated(forRemoval = true, since = "0.1.3")
    @Override
