...
public final class ReflectChecked<T> implements Reflect<T> {
    ...
    /**
     * Constructs a new {@link ReflectChecked} with the specified {@link Class}. This is used for reflecting on static
     * members which do not need an instance of the {@link Class} to function, and hence {@link #object} is set to
     * {@code null}.
     *
    ...
    /**
     * Constructs a new {@link ReflectChecked} with the specified {@link Object}. The {@link Class} is obtained from
     ...
     */
    @Override
    public <V> V invoke(final String name, final Object... parameters)
