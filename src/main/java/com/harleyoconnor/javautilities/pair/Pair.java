...
public interface Pair<K, V> {
     ...
     * @throws UnsupportedOperationException thrown by default for classes that do not support this, but some
     *                                       implementations may provide it (like {@link MutablePair#setKey(Object)}).
     */
     ...
     * @return This {@link Pair} for chaining.
     * @throws UnsupportedOperationException thrown by default for classes that do not support this, but some
     *                                       implementations may provide it (like {@link MutablePair#setValue(Object)}).
     */
     ...
     * @return This {@link Pair} for chaining.
     * @throws UnsupportedOperationException thrown by default for classes that do not support this, but some
     *                                       implementations may provide it (like {@link MutablePair#setKeyValue(Object,
     *                                       Object)}).
     */
    ...
    /**
     * Gets an {@link Exception} message to inform that the {@link Pair} implementation does not support mutation of a
     * {@code field}.
     *
     * @param pairClass   The relevant {@link Pair} implementation.
     * @param nameOfField The name of the {@code field} that cannot be mutated.
    ...
    /**
     * Duplicates this {@link Pair}, creating a new {@link Pair} object with this {@link Pair}'s {@code key} and {@code
     * value}.
     *
     ...
     * it will return itself. See {@link #duplicate()} for creating a new {@link Pair} object from this one.</p>
     *
     * @return An {@link ImmutablePair} with this {@link Pair}'s {@code key} {@code value}.
     * @since JavaUtilities 0.0.9
     */
    ...
    /**
     * Returns a {@link String} representation of the {@link Pair}. Generally, a {@link Pair} will be represented in the
     * form {@code key:value}.
     *
    ...
    /**
     * Indicates whether or not the given {@link Object} {@code obj} is equal to this {@link Pair}.
     *
     * <p>Provides an alternative to {@link Object#equals(Object)} which is
     * not class sensitive - meaning this doesn't take into consideration what implementation the other pair is using.
    ...
    /**
     * Checks if this {@link Pair} is empty. View {@link EmptyPair} to see what constitutes an "empty" {@link Pair}.
     *
     * <p>The default implementation of this uses
     * {@link EmptyPair#equals(Object)}.</p>
     *
     * @return {@code true} if this {@link Pair} is empty; {@code false} otherwise.
     * @since JavaUtilities 0.1.0
     */
     ...
     * will mutate, otherwise {@link #empty()} should be used for better performance.</p>
     *
     * @param <K> The type of the key.
     * @param <V> The type of the value.
    ...
    /**
     * Returns an empty {@link Pair} object. This is one in which no value is present for the key and value (they
     * evaluate to {@code null}.
     *
