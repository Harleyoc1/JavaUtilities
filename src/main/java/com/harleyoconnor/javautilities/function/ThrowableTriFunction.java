...
public interface ThrowableTriFunction<U, S, Q, R, T extends Throwable> {
     ...
     */
    default <V> ThrowableTriFunction<U, S, Q, V, T> andThen(@NotNull ThrowableFunction<? super R, ? extends V, T> after) {
     ...
     */
    static <U, S, Q, R, T extends Throwable> ThrowableTriFunction<U, S, Q, R, T> proxy(@NotNull final TriFunction<U, S, Q, R> function) {
